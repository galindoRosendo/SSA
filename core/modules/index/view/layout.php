...
<html lang="en">
  <head>
    ...
    <link rel='shortcut icon' type='image/x-icon' href='res/favico.ico' />
    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">SIPA<sup><small><span class="label label-primary"></span></small></sup> </a>
        </div>
...
?>
          ...
          <li><a href="index.php?view=clients"><i class="fa fa-address-card"></i> Clientes </a></li>
          ...
          <li><a href="index.php?view=settings"><i class="fa fa-cogs"></i> Configuracion <small><span class="label label-warning">Beta</span></small></a></li>
        <?php endif;?>
          </ul>
<?php endif;?>
